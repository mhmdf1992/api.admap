...
import { AdService, IAdService } from './services/ad';
...
container.bind<IAdService>(types.AdService).toDynamicValue((context) => new AdService(context.get(types.MongoClient))).inSingletonScope();
